...
public class MpGenerator {
	...
	public static void main(String[] args) {
        ...
        dc.setUrl("jdbc:mysql://47.105.126.154:33306/test?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf8&autoReconnect=true&failOverReadOnly=false&useSSL=false");
        ...
        pc.setParent("com.general");
        pc.setModuleName("sys"); //此处是所属模块名称
//        pc.setEntity("entity"); //默认entity,controller,service,service.impl,mapper,mapper.xml
        ...
        sc.setInclude("test"); //表名，用，隔开  需要生产
